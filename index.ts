...
export class Client {
  constructor(token: string) {
    ...
    this.chatService = new chat.ChatService(token);
    this.commentsService = new comments.CommentsService(token);
    ...
    this.memegenService = new memegen.MemegenService(token);
